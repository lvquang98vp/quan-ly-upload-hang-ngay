        ...
        <table className="w-full min-w-[720px] border-collapse text-sm">
          <thead>
            <tr className="border-b border-slate-200 text-left text-xs uppercase tracking-wide text-slate-500 dark:border-slate-800 dark:text-slate-400">
              ...
              <th className="px-2 py-2 font-medium">Link store</th>
              <th className="px-2 py-2 font-medium">Nền tảng</th>
              <th className="px-2 py-2 font-medium text-right">Số lượng</th>
              <th className="px-2 py-2 font-medium">Đếm ngược</th>
              <th className="px-2 py-2 font-medium">Hoàn tác</th>
              <th className="px-2 py-2 font-medium">Nhập upload mới</th>
